...
namespace TestcaseStepByStep
{
    class RegionPage:CommonMethod
    {
        public void Check_something(IWebDriver _driver)
        {
            ...
            btnSearchMenu = _driver.FindElement(By.CssSelector(Locator.SEARCHMENU_TEXTBOX));
            //System.Threading.Thread.Sleep(2000);
            //btnSearchMenu.SendKeys("Region");
            SendKeys(btnSearchMenu, "Region");
            //System.Threading.Thread.Sleep(2000);
            //btnSearchMenu.SendKeys(Keys.Enter);
            SendKeys(btnSearchMenu, Keys.Enter);
        }
    }
}
